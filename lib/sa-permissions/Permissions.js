...
exports.Permissions = class {
    ...
    static extendTypes(names) {
        ...
        // get keys
        const keys = Object.keys(PermissionType_1.PermissionType);
        // check if base zero
        const firstValue = PermissionType_1.PermissionType[keys[0]];
        let factor = Object.keys(PermissionType_1.PermissionType).length;
        if (firstValue === 0) {
            factor -= 1;
        }
